...
def parse_args():
    ...
    parser.add_argument("--dataset", help="Dataset path",
                        default='D:/PythonProject/Labelme2Culane-main/data')
    ...
    parser.add_argument("--save", required=False,
                        help="Directory to save model", default="./log")
    ...
    parser.add_argument("--height", required=False, type=int,
                        help="Resize height", default=256)
    parser.add_argument("--bs", required=False, type=int,
                        help="Batch size", default=1)
    parser.add_argument("--val", required=False, type=bool,
                        help="Use validation", default=False)
    ...
    parser.add_argument("--image", default="./output",
